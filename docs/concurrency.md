---
summary: Swift concurrency notes for RepoPeek app and menu code.
read_when:
  - Changing async refresh, task groups, actors, or MainActor isolation
  - Debugging Swift concurrency warnings or Sendable errors
  - Updating Swift toolchain or concurrency build settings
---

# Swift Concurrency (Approachable) - RepoPeek Notes
