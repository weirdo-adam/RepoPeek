...
public enum RepoPeekProductConstants {
    public static let displayName = "RepoPeek"
    public static let applicationSupportDirectoryName = "RepoPeek"
    public static let cachesDirectoryName = "RepoPeek"
    public static let bundleIdentifier = "com.weirdoadam.repopeek"
}
...
public enum LocalProjectsConstants {
    // Allow ghq-style layouts (e.g. ~/ghq/gitlab.com/owner/repo) which sit 3–4 levels
