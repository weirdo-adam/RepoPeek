...
struct MenuBuildSignature: Hashable {
    ...
    let repoSearchQuery: String
    let repoSearchExpanded: Bool
    let reposDigest: Int
    let timeBucket: Int
}
...
struct CachedRateLimitSignature: Hashable {
    ...
    init(_ row: RepoPeekCachedResponseSummary) {
...
struct ActiveRateLimitSignature: Hashable {
    ...
    init(_ row: RepoPeekRateLimitSummary) {
...
struct MenuSettingsSignature: Hashable {
    ...
    let localProjectsRootPath: String?
    let selection: MenuRepoSelection
    let issueNavigatorShortcut: MenuKeyboardShortcut
    let refreshNowShortcut: MenuKeyboardShortcut
    ...
    init(settings: UserSettings, selection: MenuRepoSelection) {
        ...
        self.hiddenGroups = settings.repoList.hiddenGroups
        self.accountScopedRepositoryLists = settings.repoList.accountScopedRepositoryLists
        self.localProjectsRootPath = settings.localProjects.rootPath?
            .trimmingCharacters(in: .whitespacesAndNewlines)
        self.selection = selection
        self.issueNavigatorShortcut = settings.keyboardShortcuts.issueNavigator
        self.refreshNowShortcut = settings.keyboardShortcuts.refreshNow
...
struct RepoSignature: Hashable {
    ...
    let localRemoteWebURLHost: String?
    ...
    init(_ repo: RepositoryDisplayModel) {
        ...
        self.accountID = repo.source.identity?.accountID
        ...
        self.localRemoteWebURLHost = repo.localStatus?.remoteWebURLHost?.absoluteString
