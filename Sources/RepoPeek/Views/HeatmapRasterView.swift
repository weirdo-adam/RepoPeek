...
final class HeatmapRasterNSView: NSView {
    ...
    private var columns: Int = HeatmapLayout.minColumns
    private var accentTone: AccentTone = .gitlabGreen
    ...
    func update(cells: [HeatmapCell], columns: Int, accentTone: AccentTone, isHighlighted: Bool) {
        self.cells = cells
    ...
    private static func buildBuckets(for cells: [HeatmapCell], totalCells: Int) -> ([UInt8], UInt64) {
        ...
        for cell in cells.prefix(totalCells) {
